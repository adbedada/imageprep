...
##### YOLO Dataset ######
image_path = '../../dataset/xview/Planes/yolo_planes_test_images/'
label_path = '../../dataset/xview/Planes/yolo_planes_test_labels/'
# label_file1 = '../../dataset/xview/Planes/yolo_planes_test_labels/79_45.txt'
...
Yf = imprep.read_label_as_dict(label_file1)
